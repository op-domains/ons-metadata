...
const ADDRESS_ETH_REGISTRAR = process.env.ADDRESS_ETH_REGISTRAR || '0xbE416295d2c3afA7A903886a7725a3ed06A382f6'; // base re...
const ADDRESS_ETH_REGISTRY = process.env.ADDRESS_ETH_REGISTRY || '0xf81dC90085379ACC1B5c3C876F92A6cE55dB53F0' // ens registry
const ADDRESS_NAME_WRAPPER = process.env.ADDRESS_NAME_WRAPPER || '0x4A7c7a621834aE33282AE71e403b94Ac11024070';
